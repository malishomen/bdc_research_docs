...
for ($i = 0; $i -lt $groups.Count; $i++) {
    ...
    $workerManifest | ConvertTo-Json -Depth 8 | Set-Content -Encoding utf8 $workerManifestPath
...
$launchPlan | ConvertTo-Json -Depth 6 | Set-Content -Encoding utf8 $planPath
...
$started | ConvertTo-Json -Depth 6 | Set-Content -Encoding utf8 $startedPath
